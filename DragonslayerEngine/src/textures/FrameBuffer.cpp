...
void FrameBuffer::copyPixels(FrameBuffer& source, FrameBuffer& destination, GLenum bufferType, GLenum filter)
{
...
void FrameBuffer::copyPixels(FrameBuffer& source, unsigned int width, unsigned int height, GLenum bufferType, GLenum filter)
{
	source.bind(GL_READ_FRAMEBUFFER);
